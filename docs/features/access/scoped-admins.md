...
- **Every grant shows who made it** ("by Hoa") and whether it can share, on the Access page and in a person's or Team's access summary, so it can be revoked at once.
