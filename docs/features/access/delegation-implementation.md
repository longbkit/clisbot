...
| F   | App: Route audience editor, Connection Admin views | `packages/app/src/clisbot/hub/settings/channel-*` except identities, `channel-route-*`                                                                                                                                                                    | B                      |
...
- Connection Admin (`channel.manage`, or Organization capability) may: save that one
