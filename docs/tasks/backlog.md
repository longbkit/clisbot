...
| Planned | P1 | agents | separate active-run persistence from session continuity | [2026-04-08-observer-based-session-attach-detach-and-watch.md](2026-04-08-observer-based-session-attach-detach-and-watch.md) | 2026-04-08 | Runtime active-run state currently lives in the session continuity record; split it into a dedicated runtime persistence model with explicit invariants and restart semantics. |
