...
| Status | Priority | Feature | Task | Main Doc | Updated | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| Ready | P0 | configuration | channel fast start and credential persistence | [2026-04-13-telegram-fast-start-and-credential-persistence.md](features/configuration/2026-04-13-telegram-fast-start-and-credential-persistence.md) | 2026-04-13 | Allow explicit Slack and Telegram bootstrap with literal or env-backed CLI input, keep literals in memory only, and steer operators toward canonical credential files instead of raw config secrets. |
