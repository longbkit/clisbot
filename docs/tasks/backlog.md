...
| Ready | P0 | configuration | app and agent authorization and owner claim | [2026-04-14-app-and-agent-authorization-and-owner-claim.md](features/configuration/2026-04-14-app-and-agent-authorization-and-owner-claim.md) | 2026-04-14 | Add shared app or agent auth grammar, first-owner claim, member defaults, prompt auth context, and channel slash gating while replacing route bash policy with explicit enum semantics. |
