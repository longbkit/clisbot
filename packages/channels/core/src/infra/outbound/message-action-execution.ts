// upstream: src/infra/outbound/message-action-execution.ts@5d8067a4483
import { asOptionalRecord as asResultRecord } from "../../normalization-core/record-coerce.js";
import { normalizeOptionalString } from "../../normalization-core/string-coerce.js";
import { GatewayErrorDetailCodes } from "../../gateway-protocol/gateway-error-details.js";
import { ErrorCodes } from "../../gateway-protocol/schema/error-codes.host-adapter.js";
...
} from "./source-reply-mirror.host-adapter.js";
...
const loadMessageActionGatewayRuntime = createLazyRuntimeModule(
  () => import("./message.gateway.runtime.host-adapter.js"),
);
