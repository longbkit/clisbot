// upstream: src/infra/outbound/message-action-spec.test.ts@5d8067a4483
...
// D-CORE-016: the bootstrap plugin registry is replaced by the local host
// adapter, so the mock target moves with the import.
