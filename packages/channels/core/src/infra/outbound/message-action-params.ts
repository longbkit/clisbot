// upstream: src/infra/outbound/message-action-params.ts@5d8067a4483
...
import { canonicalizeBase64, estimateBase64DecodedBytes } from "../../media-core/base64.js";
import { basenameFromAnyPath } from "../../media-core/file-name.js";
import { extensionForMime } from "../../media-core/mime.js";
...
import { assertMediaNotDataUrl, resolveSandboxedMediaSource } from "../../agents/sandbox-paths.host-adapter.js";
...
import { root } from "../fs-safe.host-adapter.js";
...
import { MEDIA_MAX_BYTES } from "../../media/store.host-adapter.js";
import { loadWebMedia } from "../../media/web-media.host-adapter.js";
