// upstream: src/infra/outbound/message-action-runner.ts@5d8067a4483
...
import { resolveAgentWorkspaceDir, resolveSessionAgentId } from "../../agents/agent-scope.host-adapter.js";
import type { AgentToolResult } from "../../agents/runtime/index.host-adapter.js";
import { readStringArrayParam, readToolStringParam } from "../../agents/tools/common.host-adapter.js";
import type { SourceReplyDeliveryMode } from "../../auto-reply/get-reply-options.types.host-adapter.js";
import type { ReplyPayload } from "../../auto-reply/reply-payload.js";
import type { ChannelId, ChannelPlugin } from "../../channels/plugins/types.public.js";
import { resolveAgentScopedOutboundMediaAccess } from "../../media/read-capability.host-adapter.js";
import { readBooleanParam } from "../../plugin-sdk/boolean-param.js";
import { hasPollCreationParams } from "../../poll-params.js";
import { createLazyRuntimeModule } from "../../shared/lazy-runtime.js";
import { INTERNAL_MESSAGE_CHANNEL } from "../../utils/message-channel.host-adapter.js";
import { formatErrorMessage } from "../errors.js";
import { throwIfAborted } from "./abort.js";
import {
  listConfiguredMessageChannels,
  resolveMessageChannelSelection,
} from "./channel-selection.host-adapter.js";
import { shouldUseInternalSourceReplySink } from "./internal-source-reply.host-adapter.js";
import { validateExplicitMessageAccountSelection } from "./message-account-selection.host-adapter.js";
import {
...
import type { MessageSendResult } from "./message.host-adapter.js";
import {
  enforceMessageActionAllowlist,
  resolveEffectiveMessageToolsConfig,
} from "./outbound-policy.host-adapter.js";
import { getRuntimeVisibleChannelPlugin } from "./runtime-visible-channels.host-adapter.js";

const loadInternalSourceReplyPersistence = createLazyRuntimeModule(
  () => import("../../gateway/internal-source-reply-persistence.host-adapter.js"),
);
...
async function handleInternalSourceReplySendAction(
  ...
  if (!dryRun && requestedMediaCount > 0) {
    ...
    const { createReplyMediaPathNormalizer } =
      await import("../../auto-reply/reply/reply-media-paths.runtime.host-adapter.js");
