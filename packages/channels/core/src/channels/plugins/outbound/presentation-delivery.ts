// Fusion-owned port of `src/channels/plugins/outbound/presentation-delivery.ts`@5d8067a4483 (D-CORE-341): only the `ReplyPayload` import moves to the local reply-payload module.
