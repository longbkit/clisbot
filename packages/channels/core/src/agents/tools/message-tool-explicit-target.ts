// upstream: src/agents/tools/message-tool-explicit-target.ts@5d8067a4483
...
import { asToolParamsRecord, type AnyAgentTool, readToolStringParam } from "./common.host-adapter.js";
