// upstream: src/agents/tools/message-tool-decision.ts@5d8067a4483
/** Exact-run decision receipts for message-tool boundaries without a durable owner. */
import { recordMessageActionDecision } from "../../audit/message-action-decision.host-adapter.js";
import type { MessageActionResult } from "../../infra/outbound/message-action-contracts.js";
import { MessageActionDeniedError } from "../../infra/outbound/message-action-denial.js";
import { getGatewayToolCallerIdentity } from "./gateway-caller-context.host-adapter.js";
