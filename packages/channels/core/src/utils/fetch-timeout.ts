// upstream: src/utils/fetch-timeout.ts@5d8067a4483
// Fetch timeout helpers wrap fetch calls with timeout and abort behavior.
import { redactSensitiveUrlLikeString } from "../net-policy/redact-sensitive-url.js";
import { truncateUtf16Safe } from "../normalization-core/utf16-slice.js";
