// upstream: src/media/outbound-attachment.ts@5d8067a4483
...
import { saveMediaBuffer } from "./store.host-adapter.js";
...
export async function resolveOutboundAttachmentFromUrl(
  ...
  const { loadWebMedia, markTrustedGeneratedHtmlPath } = await import("./web-media.host-adapter.js");
