// upstream: src/media/configured-max-bytes.ts@5d8067a4483
// Configured media size helpers resolve maximum byte limits by media kind.
import { maxBytesForKind, type MediaKind } from "../media-core/constants.js";
import { asOptionalObjectRecord } from "../normalization-core/record-coerce.js";
import type { OpenClawConfig } from "../config/types.openclaw.js";
import { normalizeAccountId } from "../routing/account-id.js";
import { resolveNormalizedAccountEntry } from "../routing/account-lookup.js";
import { MEDIA_MAX_BYTES } from "./store.host-adapter.js";
