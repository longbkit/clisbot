// upstream: src/media/local-media-path.ts@5d8067a4483
import path from "node:path";
import { isPassThroughRemoteMediaSource } from "../media-core/media-source-url.js";
import { safeFileURLToPath } from "../infra/local-file-access.js";
import { resolveUserPath } from "../utils.host-adapter.js";
