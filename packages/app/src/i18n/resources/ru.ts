...
export const ru: TranslationResources = {
  ...
  hostUnavailable: {
    ...
    title: "Этот хост недоступен",
    body: "Он был удалён или ваш доступ изменился. Можно остаться здесь, открыть другой хост или добавить новый.",
    openOtherHost: "Открыть другой хост",
