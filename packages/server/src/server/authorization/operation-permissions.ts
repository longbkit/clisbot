...
const INBOUND_PERMISSION = {
  ...
  "agent.permissionResponses.fetch.request": "workspace.read",
  "agent.timeline.payload.get.request": "workspace.read",
  "agent.timeline.source_ranges.get.request": "workspace.read",
  ...
  "managed_access.lease.revoke.request": "hub.execute",
...
const OUTBOUND_PERMISSION = {
  ...
  "agent.permissionResponses.fetch.response": "workspace.read",
  "agent.timeline.payload.get.response": "workspace.read",
  "agent.timeline.source_ranges.get.response": "workspace.read",
  "agent.permissionResponses.updated": "workspace.read",
  ...
  "managed_access.lease.revoke.response": "hub.execute",
