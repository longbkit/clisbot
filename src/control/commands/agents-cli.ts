import { applyTemplate, expandHomePath } from "../../infra/paths.ts";
import {
...
import { applyBootstrapTemplate, getBootstrapWorkspaceState } from "../../agents/runtime/bootstrap.ts";
import { parseBotType } from "./channel-bootstrap-flags.ts";
import type {
  AdditionalMessageMode,
  ResponseMode,
} from "../../channels/config/surface-mode-config.ts";
