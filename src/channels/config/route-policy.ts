import type { CommandPrefixes } from "../../agents/commands/commands.ts";
import type { FollowUpConfig } from "../../agents/commands/follow-up-policy.ts";
import type { ChannelId } from "../integration/channel-surface-contract.ts";
import { resolveConfigDurationMs } from "../../config/runtime/duration.ts";
